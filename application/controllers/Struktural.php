...
class Struktural extends CI_Controller {
    ...
    $this->load->view('struktural/index', $data); // Ensure this view is created to display surat
    ...
    public function update_tujuan()
{
    ...
    public function insert_surat() {
        ...
        $this->load->view('template/navbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('struktural/insert_surat', $data);
        $this->load->view('template/footer');
    }
    ...
    public function Update_surat($id) {
        ...
        $this->load->view('template/navbar', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('struktural/update_surat', $data);
        $this->load->view('template/footer');
