      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <!-- form start -->
            <form method="post" action="<?= site_url('admin/update_surat_action') ?>" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" id="tgl_disposisi" name="tgl_disposisi" value="<?= htmlspecialchars($surat['tgl_disposisi'], ENT_QUOTES) ?>">
                </div>
                <div class="form-group">
